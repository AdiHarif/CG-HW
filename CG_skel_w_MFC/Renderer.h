...
class Renderer
{
	...
	void drawLinePhong(Line l, Vertex v1, Vertex v2, Normal n1, Normal n2, MeshModel* m, Face& f, Color ambient, Color emit, vector<Pixel>* pixels_drawn = NULL, vector<Vertex>* pixel_vertices=NULL, vector<Normal>* pixel_normals = NULL);
	void drawLineModeratePhong(Line l, Vertex v1, Vertex v2, Normal n1, Normal n2, MeshModel* m, Face& f, Color ambient, Color emit, vector<Pixel>* pixels_drawn = NULL, vector<Vertex>* pixel_vertices=NULL, vector<Normal>* pixel_normals=NULL);
	void drawLineSteepPhong(Line l, Vertex v1, Vertex v2, Normal n1, Normal n2, MeshModel* m,Face& f, Color ambient, Color emit, vector<Pixel>* pixels_drawn = NULL, vector<Vertex>* pixel_vertices=NULL, vector<Normal>* pixel_normals = NULL);
